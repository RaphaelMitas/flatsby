...
export const categoryBorderColorMap: Record<CategoryColorKey, string> = {
  ...
  orange: "border-orange-600 dark:border-orange-300",
  blue: "border-blue-600 dark:border-blue-300",
  cyan: "border-cyan-600 dark:border-cyan-300",
  pink: "border-pink-600 dark:border-pink-300",
  purple: "border-purple-600 dark:border-purple-300",
  gray: "border-gray-600 dark:border-gray-300",
  red: "border-red-600 dark:border-red-300",
  green: "border-green-600 dark:border-green-300",
  yellow: "border-yellow-600 dark:border-yellow-300",
  zinc: "border-zinc-600 dark:border-zinc-300",
};
